    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(max_length=10000, verbose_name='Yorum')),
                ...
                ('sozluk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appMy.sozluk', verbose_name='Sözlük')),
            ],
        ),
    ]
